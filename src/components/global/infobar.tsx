...
const InfoBar = ({ notifications, subAccountId, agencyId, className, role, agencyLogo, agencyName, userData }: Props) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          'fixed z-[60] top-0 left-0 right-0 h-16 px-0 bg-gradient-to-r from-orange-500 to-rose-600 flex gap-4 items-center',
          className
        )}
      >
        ...
        <div className="flex-1 flex items-center justify-center gap-4 px-4" ref={searchRef}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm bg-white/10 border border-white/20 rounded-lg text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/50 transition-all"
            />
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all hover:scale-110 relative">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="rounded-full w-8 h-8 bg-white/10 hover:bg-white/20 flex items-center justify-center transition-all hover:scale-110 relative">
