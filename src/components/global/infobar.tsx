...
const InfoBar = ({ notifications, subAccountId, agencyId, className, role, agencyLogo, agencyName, userData }: Props) => {
  ...
  return (
    <>
      <div
        className={twMerge(
          'fixed z-[60] top-0 left-0 right-0 h-16 px-0 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 flex gap-4 items-center',
          className
        )}
      >
        ...
        <div className="flex-1 flex items-center justify-center gap-4 px-4" ref={searchRef}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 transition-all"
            />
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center transition-all hover:scale-110 relative">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center transition-all hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-700 dark:text-gray-300">
          ...
          <Sheet>
            <SheetTrigger>
              <div className="rounded-full w-8 h-8 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center justify-center transition-all hover:scale-110 relative">
                <Bell size={15} className="text-gray-700 dark:text-gray-300" />
                {hasNotifications && (
                  <span className="absolute -top-1 -right-1 bg-destructive text-white text-xs rounded-full w-4 h-4 flex items-center justify-center text-[10px] border border-background">
                    {notificationCount}
                  </span>
