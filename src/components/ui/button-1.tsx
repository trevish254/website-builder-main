...
const GradientButton = ({
    ...
    after:content-[""] after:block after:absolute after:bg-[var(--color-bg-card,var(--color-background))]
    after:inset-[2px] after:rounded-[10px] after:z-[1]
  ...
  `;
    ...
    return (
        ...
        `}
                ...
                {...props}
            >
                <div className="relative z-10 flex items-center justify-center gap-2 label">
                    {children}
                </div>
            </div>
        </div>
