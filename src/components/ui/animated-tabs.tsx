        ...
        content: (
            <div className="grid grid-cols-2 gap-4 w-full h-full">
                <img
                    ...
                    alt="Tab 1"
                    className="rounded-lg w-full h-40 object-cover mt-0 !m-0 shadow-[0_0_20px_rgba(0,0,0,0.2)] border-none"
                />

                <div className="flex flex-col gap-y-2">
                    <h2 className="text-xl font-bold mb-0 text-white mt-0 !m-0">
                        Tab 1
                    </h2>
                    <p className="text-xs text-gray-200 mt-0">
...
const AnimatedTabs = ({
    ...
    return (
        <div className={cn("w-full max-w-lg flex flex-col gap-y-1", className)}>
            <div className="flex gap-2 flex-wrap bg-[#11111198] bg-opacity-50 backdrop-blur-sm p-1 rounded-xl w-fit">
                {tabs.map((tab) => (
                    <button
                        key={tab.id}
            ...
            <div className="p-4 bg-[#11111198] shadow-[0_0_20px_rgba(0,0,0,0.2)] text-white bg-opacity-50 backdrop-blur-sm rounded-xl border border-white/10 min-h-[220px] h-full">
                {tabs.map(
                    (tab) =>
                        activeTab === tab.id && (
                            <motion.div
