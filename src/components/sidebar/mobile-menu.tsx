                    ...
                    <div className="p-6 pb-4 border-b border-gray-200 dark:border-gray-800">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 text-sm bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-md text-gray-700 dark:text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/30"
                            />
                        </div>
                    </div>
