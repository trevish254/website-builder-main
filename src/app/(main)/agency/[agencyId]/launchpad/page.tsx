...
const LaunchPadPage = async ({ params, searchParams }: Props) => {
  console.log('Loading launchpad page for testing')
  ...
  const integrations = {
    ...
    business: { completed: true, name: 'Business Profile', description: 'Company details and settings' }
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <CardHeader>
            ...
            <CardDescription>
                Essential steps to get your agency running smoothly
            </CardDescription>
          </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <Card className={`border-0 shadow-lg transition-all duration-300 hover:shadow-xl ${integrations.kra.completed ? 'bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20' : 'bg-white/80 dark:bg-slate-800/80'} backdrop-blur-sm`}>
              <CardContent className="p-6">
                ...
                <Link href={`/agency/${params.agencyId}/government-services`} className="mt-4 block">
                  <Button size="sm" className="w-full" variant={integrations.kra.completed ? "outline" : "default"}>
            ...
            <Card className={`border-0 shadow-lg transition-all duration-300 hover:shadow-xl ${integrations.business.completed ? 'bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20' : 'bg-white/80 dark:bg-slate-800/80'} backdrop-blur-sm`}>
              <CardContent className="p-6">
                ...
                <Link href={`/agency/${params.agencyId}/settings`} className="mt-4 block">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`/agency/${params.agencyId}`}>
