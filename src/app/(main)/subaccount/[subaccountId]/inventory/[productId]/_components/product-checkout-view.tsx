        ...
        <div className="flex flex-col gap-8 pb-20 w-full bg-background/50 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between sticky top-0 z-30 bg-background/80 backdrop-blur-md py-4 px-6 border-b border-border/40">
                ...
                >
                    ...
                    <span className="font-semibold text-sm">Return to Editor</span>
                </Button>
                                    ...
                                    <div className="space-y-3">
                                        {product.shippingDelivery && (
                                            <div className="flex flex-col gap-0.5">
                                                <span className="text-[9px] font-bold text-muted-foreground/60 uppercase">Domestic</span>
                                                <span className="text-xs font-bold">{product.shippingDelivery}</span>
                                            </div>
                                        )}
                                        {product.shippingArrival && (
                                            <div className="flex flex-col gap-0.5">
                                                <span className="text-[9px] font-bold text-muted-foreground/60 uppercase">Arrival</span>
                                    ...
                                    {(product.paymentTaxInfo || product.paymentTerms) && (
                                        <div className="flex flex-col gap-2">
                                            {product.paymentTaxInfo && (
                                                <div className="flex flex-col gap-0.5">
                                                    <span className="text-[9px] font-bold text-muted-foreground/60 uppercase">Tax Info</span>
                                                    <span className="text-xs font-bold">{product.paymentTaxInfo}</span>
                                                </div>
                                            )}
                                            {product.paymentTerms && (
                                                <div className="flex flex-col gap-0.5">
                                                    <span className="text-[9px] font-bold text-muted-foreground/60 uppercase">Payment Terms</span>
                ...
                <div className="lg:col-span-3">
                    <Card className="rounded-[32px] border-border/50 shadow-2xl bg-card sticky top-24 overflow-hidden overflow-y-auto max-h-[calc(100vh-120px)]">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className={cn(
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded-lg bg-green-500/10 text-green-500 flex items-center justify-center font-black text-[10px]">MP</div>
                        ...
                        <CardFooter className="p-6 bg-muted/10">
                            <Button className="w-full h-14 rounded-2xl bg-primary text-white font-black text-sm uppercase tracking-widest shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all group">
                                Proceed to Terminal
