...
import { Lane, Ticket } from '@/lib/database.types'
  ...
  return (
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in">
        ...
        {allLanes.length == 0 && (
          <div className="flex items-center justify-center w-full py-12 flex-col gap-4 mt-8">
            <Flag className="w-16 h-16 text-muted-foreground opacity-50" />
            <div className="text-center">
              <h3 className="text-lg font-semibold">No lanes yet</h3>
              <p className="text-sm text-muted-foreground mt-2">
                Create your first lane to start organizing tickets
              </p>
            </div>
          </div>
        )}
