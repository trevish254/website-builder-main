...
const VideoRoomPage = () => {
    ...
    useEffect(() => {
        ...
        const loadRoom = async () => {
            ...
            try {
                ...
                if (isSubscribed) toast.error('Failed to join video room')
            } finally {
    ...
    }, [user?.id, roomId, joinRoom, status])
        ...
        return (
            <div className="h-screen w-screen flex flex-col items-center justify-center bg-zinc-950 text-white gap-6">
                ...
                <button
                    ...
                    className="px-8 py-3 bg-rose-600 hover:bg-rose-700 rounded-xl font-bold transition-all shadow-lg shadow-rose-600/40"
                >
                    Close Tab
                </button>
            </div>
